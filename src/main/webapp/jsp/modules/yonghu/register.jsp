                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input id="yonghuIdNumber" name="yonghuIdNumber" class="form-control"
                                           onchange="yonghuIdNumberChickValue(this)"  placeholder="员工身份证号">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>员工手机号</label>
                                    <input id="yonghuPhone" name="yonghuPhone" class="form-control"
                                           onchange="yonghuPhoneChickValue(this)"  placeholder="员工手机号">
                                </div>
                                <div class="form-group col-md-12">
        ...
        function validform() {
            return $("#register").validate({
                ...
                messages: {
                        ...
                        yonghuName: "员工姓名不能为空",
                        sexTypes: "员工性别不能为空",
                        yonghuIdNumber: "员工身份证号不能为空",
                        yonghuPhone: "员工手机号不能为空",
                        fendianId: "分店id不能为空",
                }
            }).form();
        }
