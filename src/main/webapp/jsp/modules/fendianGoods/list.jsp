        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">分店物资管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">分店物资管理</li>
                            <li class="breadcrumb-item active">分店物资列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">分店物资列表</h3>
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        分店等级
                                        <div class="layui-input-inline">
                                            <select name="fendianTypesSelectSearch"  style="width: 150px;" id="fendianTypesSelectSearch" class="form-control form-control-sm"
                                                    aria-controls="tableId">
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        分店地址
                                        <div class="layui-input-inline">
                                            <input type="text" id="fendianAddressSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="分店地址" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(fendianNameCell);
                        ...
                        //分店等级
            var fendianTypesCell = document.createElement('td');
            fendianTypesCell.innerHTML = item.fendianValue;
            row.appendChild(fendianTypesCell);


                    //分店地址
            var fendianAddressCell = document.createElement('td');
            fendianAddressCell.innerHTML = item.fendianAddress;
            row.appendChild(fendianAddressCell);


                    //分店详情
            var fendianContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.fendianContent && item.fendianContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.fendianContent.indexOf('<img');
                var endIndex = item.fendianContent.indexOf('>');
                    fendianContentCell.innerHTML = item.fendianContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.fendianContent != null && item.fendianContent != "" && item.fendianContent.length >= 11) {
                        fendianContentCell.innerHTML = item.fendianContent.substring(0, 10) + "...";
                } else {
                        fendianContentCell.innerHTML = item.fendianContent;
                }
            }
            row.appendChild(fendianContentCell);
            ...
            // 整数
            function fendianGoodsNumberChickValue(e){
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("fendianGoods/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addfendianGoods", "addfendianGoods");
            window.location.href = "add-or-update.jsp"
        }
