                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="fendianGoodsOrderListNumberStartSearch" style="width: 100px;" class="form-control form-control-sm" onchange="fendianGoodsOrderListNumberChickValue(this)"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="text" id="fendianGoodsOrderListNumberEndSearch" style="width: 100px;" class="form-control form-control-sm" onchange="fendianGoodsOrderListNumberChickValue(this)"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="goodsNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="分店物品名字" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        分店物资数量
                                        <div class="layui-input-inline">
                                            <input type="text" id="fendianGoodsNumberStartSearch" style="width: 100px;" class="form-control form-control-sm" onchange="fendianGoodsNumberChickValue(this)"
                                                   placeholder="开始" aria-controls="tableId">
                                        </div>
                                    </div>
                                    -
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="text" id="fendianGoodsNumberEndSearch" style="width: 100px;" class="form-control form-control-sm" onchange="fendianGoodsNumberChickValue(this)"
                                                   placeholder="结束" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            if(goodsTypesSelectSearchInput != null){
                ...
                if( goodsTypesIndex  != 0){
                    searchForm.goodsTypes = document.getElementById("goodsTypesSelectSearch").options[goodsTypesIndex].value;
                                ...
                                //分店物资数量
            var fendianGoodsNumberStartSearchInput = $('#fendianGoodsNumberStartSearch');
            if(fendianGoodsNumberStartSearchInput != null){
                var fendianGoodsNumberStartSearchValue = fendianGoodsNumberStartSearchInput.val();
                if( fendianGoodsNumberStartSearchValue  != 0){
                    searchForm.fendianGoodsNumberStart = fendianGoodsNumberStartSearchValue;
                }
            }
            var fendianGoodsNumberEndSearchInput = $('#fendianGoodsNumberEndSearch');
            if(fendianGoodsNumberEndSearchInput != null){
                var fendianGoodsNumberEndSearchValue = fendianGoodsNumberEndSearchInput.val();
                if( fendianGoodsNumberEndSearchValue  != 0){
                    searchForm.fendianGoodsNumberEnd = fendianGoodsNumberEndSearchValue;
                }
            }
            ...
            if(discountMoneyEndSearchInput != null){
                ...
                //数量
            var fendianGoodsOrderListNumberStartSearchInput = $('#fendianGoodsOrderListNumberStartSearch');
            if(fendianGoodsOrderListNumberStartSearchInput != null){
                var fendianGoodsOrderListNumberStartSearchValue = fendianGoodsOrderListNumberStartSearchInput.val();
                if( fendianGoodsOrderListNumberStartSearchValue  != 0){
                    searchForm.fendianGoodsOrderListNumberStart = fendianGoodsOrderListNumberStartSearchValue;
                }
            }
            var fendianGoodsOrderListNumberEndSearchInput = $('#fendianGoodsOrderListNumberEndSearch');
            if(fendianGoodsOrderListNumberEndSearchInput != null){
                var fendianGoodsOrderListNumberEndSearchValue = fendianGoodsOrderListNumberEndSearchInput.val();
                if( fendianGoodsOrderListNumberEndSearchValue  != 0){
                    searchForm.fendianGoodsOrderListNumberEnd = fendianGoodsOrderListNumberEndSearchValue;
                }
            }
                getDataList();
        }
        ...
        function getDataList() {
            http("fendianGoodsOrderList/page", "GET", {
                ...
                order: sortOrder,
                //本表的
                fendianGoodsOrderListNumberStart: searchForm.fendianGoodsOrderListNumberStart,
                fendianGoodsOrderListNumberEnd: searchForm.fendianGoodsOrderListNumberEnd,
            //级联表的
                goodsName: searchForm.goodsName,
                goodsTypes: searchForm.goodsTypes,
                fendianGoodsNumberStart: searchForm.fendianGoodsNumberStart,
                fendianGoodsNumberEnd: searchForm.fendianGoodsNumberEnd,
        ...
        function setDataRow(item, number) {
           ...
           /*             //分店
            var fendianIdCell = document.createElement('td');
            fendianIdCell.innerHTML = item.fendianId;
            row.appendChild(fendianIdCell);
            ...
            // row.appendChild(caozuoTableCell);
                        ...
                        //会员
            // var huiyuanIdCell = document.createElement('td');
            // huiyuanIdCell.innerHTML = item.huiyuanId;
            // row.appendChild(huiyuanIdCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("fendianGoodsOrderList/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addfendianGoodsOrderList", "addfendianGoodsOrderList");
            window.location.href = "add-or-update.jsp"
        }
