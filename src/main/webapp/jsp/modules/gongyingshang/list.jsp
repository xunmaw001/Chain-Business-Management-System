...
<!--/Pre Loader -->
                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        供应商信用等级
                                        <div class="layui-input-inline">
                                            <select name="gongyingshangXinyongTypesSelectSearch"  style="width: 150px;" id="gongyingshangXinyongTypesSelectSearch" class="form-control form-control-sm"
                                                    aria-controls="tableId">
                                            </select>
                                        </div>
                                    </div>
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //供应商信用等级
            var gongyingshangXinyongTypesCell = document.createElement('td');
            gongyingshangXinyongTypesCell.innerHTML = item.gongyingshangXinyongValue;
            row.appendChild(gongyingshangXinyongTypesCell);
