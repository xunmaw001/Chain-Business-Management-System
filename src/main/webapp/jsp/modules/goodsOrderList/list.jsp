        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">采购调度详情表管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">采购调度详情表管理</li>
                            <li class="breadcrumb-item active">采购调度详情表列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">采购调度详情表列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="goodsOrderListNumberStartSearch" style="width: 100px;" class="form-control form-control-sm" onchange="goodsOrderListNumberChickValue(this)"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="text" id="goodsOrderListNumberEndSearch" style="width: 100px;" class="form-control form-control-sm" onchange="goodsOrderListNumberChickValue(this)"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            if(goodsOrderTypesSelectSearchInput != null){
                ...
                //数量
            var goodsOrderListNumberStartSearchInput = $('#goodsOrderListNumberStartSearch');
            if(goodsOrderListNumberStartSearchInput != null){
                var goodsOrderListNumberStartSearchValue = goodsOrderListNumberStartSearchInput.val();
                if( goodsOrderListNumberStartSearchValue  != 0){
                    searchForm.goodsOrderListNumberStart = goodsOrderListNumberStartSearchValue;
                }
            }
            var goodsOrderListNumberEndSearchInput = $('#goodsOrderListNumberEndSearch');
            if(goodsOrderListNumberEndSearchInput != null){
                var goodsOrderListNumberEndSearchValue = goodsOrderListNumberEndSearchInput.val();
                if( goodsOrderListNumberEndSearchValue  != 0){
                    searchForm.goodsOrderListNumberEnd = goodsOrderListNumberEndSearchValue;
                }
            }
                getDataList();
        }
        ...
        function getDataList() {
            http("goodsOrderList/page", "GET", {
                ...
                order: sortOrder,
                //本表的
                goodsOrderListNumberStart: searchForm.goodsOrderListNumberStart,
                goodsOrderListNumberEnd: searchForm.goodsOrderListNumberEnd,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //
            //             //供应商
            // var gongyingshangIdCell = document.createElement('td');
            // gongyingshangIdCell.innerHTML = item.gongyingshangId;
            // row.appendChild(gongyingshangIdCell);
            ...
            // 整数
            function goodsOrderListNumberChickValue(e){
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addgoodsOrderList", "addgoodsOrderList");
            window.location.href = "add-or-update.jsp"
        }
